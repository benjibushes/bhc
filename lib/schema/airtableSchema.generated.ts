...
export const SCHEMA_GENERATED_AT = "2026-08-19T17:22:31.195Z";
...
export const AIRTABLE_TABLE_FIELDS: Readonly<Record<string, readonly string[]>> = {
  ...
  "Cron Runs": ["Duration ms", "Ended At", "Errors", "Name", "Notes", "Records Touched", "Run Count", "Run Day", "Skip Reason Breakdown", "Source Commit", "Started At", "Status"],

// Relative, not an absolute path off one laptop. This file imported
// `/Users/<someone>/…/funnelScore.ts`, which resolved on exactly one machine
// and nowhere else — which is precisely why nobody noticed it had fallen out
// of the `npm test` glob. It is now in the glob and must run in CI.
import { scoreFunnel } from '../../app/components/funnel/funnelScore.ts';

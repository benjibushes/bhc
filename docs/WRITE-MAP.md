...
W: rancher Mark Lost modal :139,149,442; quick-action :345 (map :132). Rancher-initiated by construction (lib/lossScorecard.ts:11); cron auto-closes NEVER write it.
...
Sem: presence = genuine rancher-initiated loss. Bulk-backfilling it would poison the loss-recovery cron's day-window guard (loss-recovery :86).
...
R: matching/suggest :589 buyerZipServedBy (FAILS CLOSED), :763 (direct-pin), :795 (offline centroid ranking — NEVER live-geocode); checkout/deposit :163; zipGatherCampaign.ts:67.

...
**194 variables · 26 load-bearing** (+8 prod-set orphans documented in the last section — set in Vercel but read by no code). Owner legend: **ben-flips** = a business switch you toggle deliberately · **set-once** = key/secret, set correctly and forget (watchdog guards it) · **code-default** = safe fallback exists.

    ...
    <main className="min-h-screen py-24 bg-bone text-charcoal flex items-center justify-center">
      <div className="max-w-md mx-auto text-center space-y-6 px-6">
        ...
        <div className="flex gap-4 justify-center pt-4">
          <button
            onClick={reset}
            className="px-6 py-3 bg-charcoal text-bone hover:bg-divider transition-colors uppercase font-semibold tracking-wider text-sm"
          >
            Try Again
          </button>
          <a
            href="/"
            className="px-6 py-3 border border-charcoal hover:bg-charcoal hover:text-bone transition-colors uppercase font-semibold tracking-wider text-sm"
          >
            Go Home
          </a>
        </div>

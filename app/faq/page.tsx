      ...
      <Container>
        <div className="max-w-3xl mx-auto space-y-16">
          ...
          <section className="space-y-8">
            <h2 className="font-serif text-3xl border-b border-dust pb-4">
              How It Works
            </h2>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <ol className="list-decimal list-inside space-y-2 text-saddle leading-relaxed pl-4">
                  <li><strong className="text-charcoal">Verify ranchers</strong> — I visit ranches in person, document operations, ensure quality and legitimacy. Every rancher is personally certified.</li>
                  <li><strong className="text-charcoal">Vet buyers</strong> — I review member applications to protect ranchers from tire-kickers and ensure serious intent.</li>
                  <li><strong className="text-charcoal">Facilitate introductions</strong> — I match members with ranchers in their state and facilitate the introduction. You handle the transaction directly.</li>
                </ol>
                <p className="text-saddle leading-relaxed">
          ...
          <section className="space-y-8">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-saddle leading-relaxed">
                  <strong className="text-charcoal">Quarter Cow (~100-125 lbs):</strong> Mix of cuts including steaks, roasts, and ground beef. 
                  Feeds a family of 2-3 for 3-4 months. Requires about 4-5 cubic feet of freezer space.
                </p>
                <p className="text-saddle leading-relaxed">
                  <strong className="text-charcoal">Half Cow (~200-250 lbs):</strong> Full variety of cuts — ribeyes, T-bones, chuck roasts, brisket, short ribs, ground beef. 
                  Feeds a family of 4 for 6-8 months. Requires about 8-10 cubic feet of freezer space.
                </p>
                <p className="text-saddle leading-relaxed">
                  <strong className="text-charcoal">Whole Cow (~400-500 lbs):</strong> Complete animal, maximum variety and value. 
              ...
              <div className="space-y-4">
                ...
                <p className="text-saddle leading-relaxed">
                  Typically <strong className="text-charcoal">$1,200-$2,500</strong> depending on:
                </p>
                <ul className="list-disc list-inside space-y-2 text-saddle leading-relaxed pl-4">
          ...
          <section className="space-y-8">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-saddle leading-relaxed">
                  <strong className="text-charcoal">Launch week:</strong> 24-48 hours (high volume, please be patient)
                  <br />
                  <strong className="text-charcoal">Normal:</strong> Same day, typically within 6-12 hours
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ol className="list-decimal list-inside space-y-2 text-saddle leading-relaxed pl-4">
                  <li><strong className="text-charcoal">Protect ranchers</strong> — Ranchers get bombarded by tire-kickers and time-wasters. I filter out non-serious buyers so ranchers only spend time on real opportunities.</li>
                  <li><strong className="text-charcoal">Maintain quality</strong> — This is a private community, not a public marketplace. Vetting ensures the network stays focused on real sourcing and quality relationships.</li>
                </ol>
              </div>
          ...
          <section className="space-y-8">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-saddle leading-relaxed pl-4">
                  <li><strong className="text-charcoal">In-person ranch tours</strong> — I visit operations, document practices, meet the ranchers</li>
                  <li><strong className="text-charcoal">Documentation review</strong> — Business licenses, certifications, operation history</li>
                  <li><strong className="text-charcoal">Reference checks</strong> — Past customers, industry connections</li>
                </ul>
                <p className="text-saddle leading-relaxed">
          ...
          <section className="space-y-8">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-saddle leading-relaxed">
                  <strong className="text-charcoal">Application to approval:</strong> 24-48 hours (launch week), usually same day
                  <br />
                  <strong className="text-charcoal">Finding a rancher:</strong> Immediate once approved (browse your state's ranchers)
                  <br />
                  <strong className="text-charcoal">Introduction facilitation:</strong> 12-24 hours (I review and approve inquiries)
                  <br />
                  <strong className="text-charcoal">Transaction with rancher:</strong> Varies — some have beef ready now, some take custom orders (4-6 months)
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-saddle leading-relaxed">
                  We have verified ranchers in <strong className="text-charcoal">30+ states</strong> and expanding weekly.
          ...
          <div className="text-center space-y-6 py-12">
            ...
            <p className="text-saddle leading-relaxed">
              Email me directly: <a href="mailto:support@buyhalfcow.com" className="text-charcoal underline">support@buyhalfcow.com</a>
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
              <Link 
                href="/access"
                className="inline-block px-8 py-4 bg-charcoal text-bone hover:bg-divider transition-colors duration-300 font-medium tracking-wide uppercase text-sm border border-charcoal text-center"
              >
                Join the network
              </Link>
              <Link 
                href="/"
                className="inline-block px-8 py-4 bg-transparent text-charcoal hover:bg-charcoal hover:text-bone transition-colors duration-300 font-medium tracking-wide uppercase text-sm border border-charcoal text-center"
              >
                Back to Home
              </Link>
            </div>

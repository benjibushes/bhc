          ...
          {status === 'error' && (
            <>
              ...
              <div className="pt-4">
                <Link
                  href="/member/login"
                  className="inline-block px-6 py-3 bg-charcoal-black text-bone-white hover:bg-saddle-brown transition-colors font-medium tracking-wider uppercase text-sm"
                >
                  Request New Link
                </Link>
              </div>

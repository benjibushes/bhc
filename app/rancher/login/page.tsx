        ...
        <Container>
          <div className="max-w-md mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-saddle-brown leading-relaxed">
              If you have a registered rancher account, you&apos;ll receive a login link at <strong className="text-charcoal-black">{email}</strong>.
            </p>
      ...
      <Container>
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-8 text-center space-y-3">
            <p className="text-sm text-dust-gray">Not a registered rancher?</p>
            <Link href="/partner" className="inline-block text-charcoal-black hover:text-saddle-brown transition-colors text-sm font-medium">
